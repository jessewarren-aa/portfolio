...
export const meta = {
  author: 'Jesse Warren',
  date: '2022-09-19',
  title: 'Creating social influence using the Twitter API, a follow-up',
  description:
    `My favourite definition of social influence belongs to the APA's dictionary of psychology: "any change in an individual’s thoughts, feelings, or behaviors caused by other people, who may be actually present or whose presence is imagined, expected, or only implied."`,
}
